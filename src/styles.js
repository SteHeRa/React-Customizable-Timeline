...
//PHONE STYLINGS
//===============
export const S_Title_Phone = styled.div`
  background-color: ${props => props.theme.primaryLightColor};
  font-weight: 700;
  font-size: 120%;
  display: flex;
...
export const S_Timeline_Phone = styled.div`
  border-bottom-right-radius: 4px;
  border-top-right-radius: 4px;
  color: ${props => props.theme.primaryDarkColor};
  font-family: ${props => props.theme.primaryFont};
...
export const S_TimelineSection_Phone = styled.div`
  display: flex;
...
export const S_TimelineItem_Phone = styled.div`
  padding: 0 25px 25px 25px;
  position: relative;
  border-bottom: 1px ${props => props.theme.lineStyle} ${props => props.theme.primaryDarkColor};
  border-top: 1px ${props => props.theme.lineStyle} ${props => props.theme.primaryDarkColor};
...
export const S_TimelineConnector_Phone = styled.div`
  color: props.theme.primaryDarkColor;
  position: relative;
  display: flex;
  flex-direction: column;
  align-items: center;
